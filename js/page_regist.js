	...
	var validate = $("#signupForm").validate({
		...
		messages: {
			...
			password: {
				...
				minlength: jQuery.format($.i18n.prop("请输入密码")),
				maxlength: jQuery.format($.i18n.prop("请输入密码"))
			},
			passwordAgain: {
				required: $.i18n.prop("请再次输入密码"),
				minlength: jQuery.format($.i18n.prop("请再次输入密码")),
				maxlength: jQuery.format($.i18n.prop("请再次输入密码")),
				equalTo: jQuery.format($.i18n.prop("密码不统一"))
			},
			contact: {
				required: $.i18n.prop("请输入联系人")
			},
			company: {
				required: $.i18n.prop("请输入公司")
			},
			tel: {
				required: $.i18n.prop("请输入电话"),
				digits: $.i18n.prop("电话不正确")
			},
			qq: {
				required: $.i18n.prop("请输入QQ"),
				digits: $.i18n.prop("QQ不正确")
			}
		}
	});
